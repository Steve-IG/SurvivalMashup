    ...
    public class Demo_ResolutionSelect : MonoBehaviour {
        ...
        protected void Start()
        {
            ...
            foreach (Resolution res in resolutions)
            {
                ...
                this.m_SelectField.AddOption(res.width + "x" + res.height + " @ " + res.refreshRateRatio.value + " Hz");
            }

            Resolution currentResolution = Screen.currentResolution;

            // Set the current resolution as selected
            this.m_SelectField.SelectOption(currentResolution.width + "x" + currentResolution.height + " @ " + currentResolution.refreshRateRatio.value + " Hz");
        }
